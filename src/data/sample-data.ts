import { DealData, User } from '../types/deal';
...
export const testUsers: User[] = [
  {"name":"Sarah Chen","email":"sarah.test@example.com","preferred_retailers":["Whole Foods","Sprouts"]},
  {"name":"Mike Rodriguez","email":"mike.test@example.com","preferred_retailers":["Walmart","Aldi","Smart & Final"]},
  {"name":"Emma Johnson","email":"emma.test@example.com","preferred_retailers":["Ralphs","Vons","CVS"]}
];
